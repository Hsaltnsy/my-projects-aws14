...
app.config['MYSQL_DATABASE_HOST'] = 'database-1.cccuvf8h0hk8.us-east-1.rds.amazonaws.com'
...
VALUES 
    ("David", "david@amazon.com"),
    ("James", "james@google.com"),
    ("Bill", "bill@bmw.com"),
    ("George", "george@mercedes.com"),
    ("Teressa", "teressa@porche.com"),
    ("Tim", "tim@tesla.com"),
    ("Henry", "henry@tesla.com"),
    ("Talisca", "talisca@samsung.com");
"""
